...
export default function TabExport() {
  return (
    <div className="flex w-full py-2 flex-col gap-3">
      <div className="flex flex-col gap-2">
        <p className="font-bold text-sm  text-blue-400">Snapshot</p>
        <p>Size</p>
        <div className="flex flex-row gap-2">
          <input type="number" className="outline-0 border border-gray-300 w-1/2 bg-white rounded-sm px-2 py-1" />
          <input type="number" className="outline-0 border border-gray-300 w-1/2 bg-white rounded-sm px-2 py-1" />
        </div>
      ...
      <div className="flex flex-col gap-2">
        <p className="font-bold text-sm  text-blue-400">3D file</p>
      ...
      <hr className="text-gray-400" />
      <div className="flex flex-col gap-2">
        <p className="font-bold text-sm  text-blue-400">Scene Settings</p>
        <p className="text-xs">
      ...
      <hr className="text-gray-400" />
      <div className="flex flex-col gap-2">
        <p className="font-bold text-sm  text-blue-400">Turntable video</p>
        <p>Size</p>
        <div className="flex flex-row gap-2">
          <input type="number" className="outline-0 border border-gray-300 w-1/2 bg-white rounded-sm px-2 py-1" />
          <input type="number" className="outline-0 border border-gray-300 w-1/2 bg-white rounded-sm px-2 py-1" />
        ...
        <div className="flex flex-row gap-2 w-[96%]">
          <div className="flex flex-col w-1/2 gap-2">
            ...
            <input type="number" id="FPS" className="outline-0 border border-gray-300 bg-white rounded-sm px-2 py-1" />
          </div>
          <div className="flex flex-col w-1/2 gap-2">
            <label htmlFor="AA">AA quality</label>
            <input type="number" id="AA" className="outline-0 border border-gray-300 bg-white rounded-sm px-2 py-1" />
          </div>
        </div>
        <p>Duration</p>
        <input type="number" className="outline-0 border border-gray-300 w-full bg-white rounded-sm px-2 py-1" />
        <button className="px-2 py-1 rounded-full outline-0 bg-blue-400 hover:bg-blue-500 text-white">Download</button>
      </div>
    </div>
  )
